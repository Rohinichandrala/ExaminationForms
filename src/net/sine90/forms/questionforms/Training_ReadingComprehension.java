 ...
 * @author rohini
 */
public class Training_ReadingComprehension extends javax.swing.JFrame {

    /**
     * Creates new form PreTest_Reading
     */
    Training_ReadingComprehension1 child;
    Timer timer;
    public Training_ReadingComprehension() {
        initComponents();
        jTextArea1.setText(ReadingTestParameters.training_test_com);
...
//        ReadingTestMain.main(null);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       child=new Training_ReadingComprehension1();
...
private void submitForm()
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Training_ReadingComprehension.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Training_ReadingComprehension().setVisible(true);
            }
        });
    }
