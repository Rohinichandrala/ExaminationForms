    ...
    private void submitForm()
    {
        ...
        File file=new File("C:\\Results\\Listening\\"+fileName);
            ...
            try {
                ...
                training1_answer.append("2."+correctAnswer+"1"+System.getProperty("line.separator")+wrongAnswer+jTextField13.getText().trim()+System.getProperty("line.separator"));
                ...
                training1_answer.append("3."+correctAnswer+"6"+System.getProperty("line.separator")+wrongAnswer+jTextField14.getText().trim()+System.getProperty("line.separator"));
                if("2".equalsIgnoreCase(jTextField15.getText().trim()))
                {
                training1_answer.append("4."+correctAnswer+jTextField15.getText().trim()+System.getProperty("line.separator"));
                 marks_obtained++;
                }
                else
                training1_answer.append("4."+correctAnswer+"2"+System.getProperty("line.separator")+wrongAnswer+jTextField15.getText().trim()+System.getProperty("line.separator"));
