 ...
 * @author rohini
 */
public class WritingTestMain extends javax.swing.JFrame {

    /**
     * Creates new form WritingTestMai
     */
    public WritingTestMain() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WritingTestMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WritingTestMain().setVisible(true);
            }
        });
    }
