 ...
 * @author rohini
 */
public class PostTest_ReadingComprehension extends javax.swing.JFrame {

    /**
     * Creates new form PreTest_Reading
     */
    PostTest_ReadingComprehension1 child;
    Timer timer;
    public PostTest_ReadingComprehension() {
        initComponents();
        jTextArea1.setText(ReadingTestParameters.post_test_com);
ActionListener taskPerformer = new ActionListener() {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Topic: II) ADAPTING TO SURVIVE");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       child=new PostTest_ReadingComprehension1();
    ...
    private void submitForm()
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PostTest_ReadingComprehension.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PostTest_ReadingComprehension().setVisible(true);
            }
        });
    }
